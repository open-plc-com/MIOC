...
#else
#define SSD1306_WRITECOMMAND(command) I2C_write_one(SSD1306_I2C, SSD1306_I2C_ADDR, 0x00, (command))
#endif
/* Write data */
...
// ===========================================================================
{
    ...
    for( m = 0; m < 8; m++ )
    {
        ...
        I2C_write_many( SSD1306_I2C, SSD1306_I2C_ADDR, 0x40, SSD1306_WIDTH, &SSD1306_Buffer[SSD1306_WIDTH * m] );
    }
}
// ===========================================================================
...
// ===========================================================================
void SSD1306_write_string( int i, char *s )
// ===========================================================================
{
	char sd[12];
	int j, n;
    ...
    switch( i )
    {
        case 1:
            SSD1306_GotoXY( 0, 1 );
            SSD1306_Puts( sd, &Font_11x18, SSD1306_COLOR_WHITE );
            SSD1306_UpdateScreen();
            break;
        case 2:
            SSD1306_GotoXY( 0, 22 );
