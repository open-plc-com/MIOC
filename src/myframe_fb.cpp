...
m_separator2 = m_menu_tools->AppendSeparator();
wxMenuItem* m_menu_fw;
m_menu_fw = new wxMenuItem( m_menu_tools, ID_TOOL_GENERATE, wxString( wxT("Firmware code generate\tF8") ) , wxEmptyString, wxITEM_NORMAL );
m_menu_tools->Append( m_menu_fw );
...
wxMenuItem* m_menu_functions;
m_menu_functions = new wxMenuItem( m_help, ID_TOOL_FUNCTIONS, wxString( wxT("Functions\tF3") ) , wxEmptyString, wxITEM_NORMAL );
m_help->Append( m_menu_functions );
...
m_main_tool->AddTool( ID_TOOL_GENERATE, wxT("tool"), wxBitmap( make_fw_xpm ), wxNullBitmap, wxITEM_NORMAL, wxT("Firmware code generate (F8)"), wxEmptyString );
...
m_main_tool->AddSeparator();
m_static_comment = new wxStaticText( m_main_tool, wxID_ANY, wxT("Comment: "), wxDefaultPosition, wxDefaultSize, 0 );
m_static_comment->Wrap( -1 );
m_main_tool->AddControl( m_static_comment );
...
m_main_tool->AddSeparator();
m_main_tool->AddSeparator();
m_main_tool->AddTool( ID_TOOL_CONNECT, wxT("tool"), wxBitmap( empty_xpm ), wxNullBitmap, wxITEM_NORMAL, wxT("Connect/Disconnect COM-port"), wxEmptyString );
m_staticTextCOM = new wxStaticText( m_main_tool, wxID_ANY, wxT("COM-port : "), wxDefaultPosition, wxDefaultSize, 0 );
m_staticTextCOM->Wrap( -1 );
m_staticTextCOM->Hide();
m_main_tool->AddControl( m_staticTextCOM );
m_tool_com_port = new wxTextCtrl( m_main_tool, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 60,-1 ), wxTE_READONLY );
m_tool_com_port->Hide();
...
m_grid = new wxGrid( m_data_panel, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0 );
...
bSizer22->Add( m_grid, 1, wxALL|wxEXPAND, 5 );
...
m_tool_UART->Realize();
bSizerUART->Add( m_tool_UART, 0, wxALIGN_CENTER_VERTICAL, 5 );
sbSizerSerial->Add( bSizerUART, 0, wxALIGN_CENTER_VERTICAL|wxLEFT, 5 );
...
m_staticline_indicators = new wxStaticLine( m_config_window, wxID_ANY, wxDefaultPosition, wxSize( -1,5 ), wxLI_HORIZONTAL );
bSizer4->Add( m_staticline_indicators, 0, wxEXPAND|wxBOTTOM, 5 );
...
sbSizerDisplayI2C = new wxStaticBoxSizer( new wxStaticBox( m_config_window, wxID_ANY, wxT("Display I2C1") ), wxHORIZONTAL );
m_staticline8 = new wxStaticLine( m_config_window, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
sbSizerDisplayI2C->Add( m_staticline8, 0, wxEXPAND|wxBOTTOM|wxLEFT, 5 );
wxBoxSizer* bSizer7;
...
bSizer7->Add( m_staticline11, 0, wxEXPAND|wxTOP|wxBOTTOM, 5 );
...
sbSizerDisplayI2C->Add( m_staticline3, 0, wxEXPAND|wxBOTTOM, 5 );
wxBoxSizer* bSizer8;
...
bSizer8->Add( m_staticline14, 0, wxEXPAND|wxTOP|wxBOTTOM, 5 );
...
sbSizerDisplayI2C->Add( m_staticline5, 0, wxEXPAND|wxBOTTOM|wxRIGHT, 5 );
...
sbSizerIndicators->Add( sbSizerDisplayI2C, 0, wxBOTTOM|wxRIGHT|wxLEFT, 5 );
bSizer4->Add( sbSizerIndicators, 0, wxBOTTOM|wxRIGHT|wxLEFT, 5 );
m_staticline_sensors = new wxStaticLine( m_config_window, wxID_ANY, wxDefaultPosition, wxSize( -1,5 ), wxLI_HORIZONTAL );
bSizer4->Add( m_staticline_sensors, 0, wxEXPAND|wxBOTTOM, 5 );
...
m_check_CCS811 = new wxCheckBox( m_toolBarSensor, wxID_ANY, wxT("CCS811"), wxDefaultPosition, wxDefaultSize, 0 );
m_toolBarSensor->AddControl( m_check_CCS811 );
m_toolBarSensor->AddTool( ID_TOOL_CCS811_HELP, wxT("tool"), wxBitmap( help_xpm ), wxNullBitmap, wxITEM_NORMAL, wxEmptyString, wxEmptyString );
m_check_EC11 = new wxCheckBox( m_toolBarSensor, wxID_ANY, wxT("Encoder EC11"), wxDefaultPosition, wxDefaultSize, 0 );
...
m_toolBarSensor->AddTool( ID_TOOL_EC11_HELP, wxT("tool"), wxBitmap( help_xpm ), wxNullBitmap, wxITEM_NORMAL, wxEmptyString, wxEmptyString );
...
m_staticline_system = new wxStaticLine( m_config_window, wxID_ANY, wxDefaultPosition, wxSize( -1,5 ), wxLI_HORIZONTAL );
bSizer4->Add( m_staticline_system, 0, wxEXPAND|wxBOTTOM, 5 );
...
m_check_MCO = new wxCheckBox( m_toolBarSystem, wxID_ANY, wxT("MCO"), wxDefaultPosition, wxDefaultSize, 0 );
...
m_ibt_fix_time = new wxTextCtrl( m_toolBarSystem, wxID_ANY, wxT("5"), wxDefaultPosition, wxSize( 40,-1 ), wxTE_READONLY|wxSIMPLE_BORDER );
...
m_staticline_bottom = new wxStaticLine( m_config_window, wxID_ANY, wxDefaultPosition, wxSize( -1,5 ), wxLI_HORIZONTAL );
bSizer4->Add( m_staticline_bottom, 0, wxBOTTOM|wxEXPAND, 5 );
...
m_check_WatchDog->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( MyFrameFB::On_check_WATCHDOG ), NULL, this );
...
m_check_WatchDog->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( MyFrameFB::On_check_WATCHDOG ), NULL, this );
...
m_staticText = new wxStaticText( m_panel, wxID_ANY, wxT("Project path and Name :"), wxDefaultPosition, wxDefaultSize, 0 );
m_staticText->Wrap( -1 );
bSizer3->Add( m_staticText, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxLEFT, 5 );
m_file = new wxFilePickerCtrl( m_panel, wxID_ANY, wxEmptyString, wxT("Select a file"), wxT("*.prj"), wxDefaultPosition, wxSize( -1,-1 ), wxFLP_DEFAULT_STYLE );
bSizer3->Add( m_file, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
...
bSizer2->Add( m_staticline, 0, wxEXPAND, 5 );
m_sdb = new wxStdDialogButtonSizer();
m_sdbOK = new wxButton( m_panel, wxID_OK );
m_sdb->AddButton( m_sdbOK );
m_sdbCancel = new wxButton( m_panel, wxID_CANCEL );
m_sdb->AddButton( m_sdbCancel );
m_sdb->Realize();
bSizer2->Add( m_sdb, 0, wxALIGN_RIGHT|wxTOP|wxBOTTOM|wxRIGHT, 5 );
...
this->Layout();
this->Centre( wxBOTH );
m_sdbOK->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Open_Project_FB::OnOkButton ), NULL, this );
}
Open_Project_FB::~Open_Project_FB()
{
m_sdbOK->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Open_Project_FB::OnOkButton ), NULL, this );
}
...
m_staticText9 = new wxStaticText( m_panel5, wxID_ANY, wxT("MIOC - Module of Input/Output Configurator v0.7.1"), wxDefaultPosition, wxDefaultSize, 0 );
...
m_hyperlink->SetFont( wxFont( 12, 70, 90, 90, false, wxEmptyString ) );
...
m_grid->SetDefaultCellAlignment( wxALIGN_LEFT, wxALIGN_TOP );
bSizer2->Add( m_grid, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, 5 );
m_staticline = new wxStaticLine( m_panel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
