...
//_log->AppendText( wxT( "New_Prj::OnDirChanged\n" ) ); _log->AppendText( s ); _log->AppendText( wxT( "\n" ) );
//_log->AppendText( wxT( "PATH_SEP=" ) ); _log->AppendText( wxT( PATH_SEP ) ); _log->AppendText( wxT( "\n" ) );
_log->AppendText( s ); _log->AppendText( wxT( "\n" ) );
}
// ===========================================================================
...
//s.Printf( wxT( "n dir files=%d\n" ), n ); _log->AppendText( s );
//_log->AppendText( prj_dir ); _log->AppendText( wxT( "\n" ) );
